...
public class HologramUtil {
    ...
    /**
     * Creates a chest lock hologram positioned in front of the sign.
    ...
    public static HologramResult createHologram(World world, double x, double y, double z, String text) {
        ...
        me.ascheladd.hytale.neolocks.NeoLocks.debug("Creating hologram at position: " + hologramTransform.getPosition());
        ...
        java.util.UUID entityUuid = java.util.UUID.randomUUID();
    ...
    public static class HologramResult {
        ...
        public HologramResult(long networkId, Ref<EntityStore> entityRef, java.util.UUID entityUuid) {
